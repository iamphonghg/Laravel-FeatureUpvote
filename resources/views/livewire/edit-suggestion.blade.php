        ...
        >
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form wire:submit.prevent="updateSuggestion" action="#" method="POST" class="space-y-4 px-4 py-6">
                    ...
                    <div>
                        <input wire:model.defer="name" type="text" class="w-full bg-gray-100 rounded-xl placeholder-gray-900 border-none font-semibold px-4 text-sm" placeholder="Your name" name="name" @if ($suggestion->createdByCurrentAdmin()) readonly @endif>
                    </div>
                    <div>
                        <input wire:model.defer="shopName" type="text" class="w-full bg-gray-100 rounded-xl placeholder-gray-900 border-none font-semibold px-4 py-2 text-sm" placeholder="Your shop name" name="shopName" @if ($suggestion->createdByCurrentAdmin()) readonly @endif>
                    </div>
                    <div>
                        <input wire:model.defer="email" type="email" class="w-full bg-gray-100 rounded-xl placeholder-gray-900 border-none font-semibold px-4 py-2 text-sm mb-2" placeholder="Your email" name="email" @if ($suggestion->createdByCurrentAdmin()) readonly @endif>
                    </div>
