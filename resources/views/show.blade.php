<x-app-layout>
    ...
    <div class="sgt-container bg-white rounded-xl flex mt-4">
        <div class="flex flex-col md:flex-row md:flex-1 px-0 md:px-5 py-4 md:py-6">
            ...
            <div class="w-full flex flex-col justify-between mx-4 md:mx-5">
                ...
                <div class="text-gray-600 mt-3 mr-4">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum repellat odit molestias quis id qui magni, maiores illo, explicabo distinctio ratione sunt nisi ea. Earum illum excepturi cumque consequatur quis!
                </div>
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    <div class="flex items-center text-xs text-gray-400 space-x-2">
                        <div class="hidden md:block font-bold text-gray-900">Phong Hoang Gia</div>
